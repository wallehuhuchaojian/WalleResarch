    ...
    public boolean dispatchTouchEvent(MotionEvent e) {
        ...
        switch (action) {
            case MotionEvent.ACTION_UP:
                if ( mPtrHandler.checkCanDoRefresh(this, mContent, mHeaderView)){
                    PtrCLog.d(LOG_TAG, "canrefresh true");
                }else {
                    PtrCLog.d(LOG_TAG, "canrefresh false");
                }

                mPtrIndicator.getOffsetToRefresh();
                mPtrIndicator.getOffsetY();
                if ( mPtrIndicator.getOffsetY()>mPtrIndicator.getOffsetToRefresh()){}else {
                    PtrCLog.d(LOG_TAG, "sendCancelEvent");
